...
public class BookReturnedMail {

//	 SendMail.sendEmail(student.getGmail(),emailSubject, emailBody);
    public static void sendEmail(String toAddress, String subjcet, String name,int tid) {
        ...
        try {
            ...
            String htmlText = "<!DOCTYPE html>"
                    ...
                    + ".banner {width: 100%; max-width: 600px;margin-left:auto; margin-right:auto;}"
                    ...
                    + "<body>"
                    + "<div class='container'>"
                    + "<img src='cid:bannerImage' alt='Company Banner' class='banner'/>"
                    + "<div class='content'>"
                    + "<h3>"+"Hello "+name+"</h3>"
                    +"<p class='tid-msg'>Book with Trans Id "+tid+" Returned Successfully</p>"
                    +"<p>Note: Thank you for returning back before the ending date without any late fee!</p>"
