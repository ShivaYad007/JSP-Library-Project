    ...
    public static void sendEmail(String toAddress, String subjcet, String name,int tid) {
        ...
        try {
            ...
            String htmlText = "<!DOCTYPE html>"
                    ...
                    + "<div class='content'>"
                    + "<h3>"+"Hello "+name+"</h3>"
                    +"<p class='tid-msg'>Your requested Book with Trans Id "+tid+" Issued Successfully</p>"
                    +"<p>Note: Please return back before the ending date to avoid late fee!</p>"
