...
<head>
<meta charset="UTF-8">
<title>Create Student Account Result</title>
<style type="text/css">
...
<jsp:include page="Header.jsp"></jsp:include> 
 <div class="container-create">
        ...
        <form id="form-create" action="CreateStudentResult.jsp" method="post" >
         ...
         <%
              if(request.getParameter("phno")!=null && request.getParameter("year_of_joining")!=null && request.getParameter("year_of_joining")!=null){
