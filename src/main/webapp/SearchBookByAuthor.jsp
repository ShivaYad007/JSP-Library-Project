...
<body>
	...
	<div class="container-search">
		...
		<form action="SearchBookByAuthor.jsp" method="post">
			<label for="author">Auhtor:</label> <input type="text" id="author"
		...
		if (request.getMethod().equalsIgnoreCase("POST")) {
            String author=request.getParameter("author"); 
              ...
              try {
                  ...
                  List<Books> books=adminserv.searchBookByAuthor(author);
                  %>
		<%
